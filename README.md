...
| #  | Workshop Project                | Files                      | Lab Project                 | Files                      |
|----|---------------------------------|----------------------------|-----------------------------|----------------------------|
| **i** | - | - | **Build a Checkout Page** | [`HTML`](HTML/Accessibility/build-a-checkout-page.html) |
...
| **iii** | **✊✋✌️ [Rock-Paper-Scissors Game](JavaScript/DOM_Manipulation_and_Events/Rock_Paper_Scissors_Game/)** | [`HTML`](JavaScript/DOM_Manipulation_and_Events/Rock_Paper_Scissors_Game/index.html)<br>[`CSS`](JavaScript/DOM_Manipulation_and_Events/Rock_Paper_Scissors_Game/styles.css)<br>[`JS`](JavaScript/DOM_Manipulation_and_Events/Rock_Paper_Scissors_Game/script.js) | **🖼️ Image Lightbox Gallery** | [`HTML`]()<br>[`CSS`]()<br>[`JS`]() |
